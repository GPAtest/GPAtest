...
<html lang="zh-CN">
  <head>
    ...
    <link rel="shortcut icon" href="/GPAtest/GPAtest/Public/ico/favicon.png">
   <!-- Bootstrap core CSS -->
    <link href="/GPAtest/GPAtest/Public/css/bootstrap.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="/GPAtest/GPAtest/Public/css/sign.css" rel="stylesheet">
...
<div class="container">
  ...
  <form account="login" class="form-signin" role="form" action="/GPAtest/GPAtest/index.php/Home/Index/index" method="post" onsubmit="return checkInfo()">
    ...
    if (event.keyCode == "13"){
     ...
     if(password==""){
      ...
      if(account!="" && password!=""){
        ...
        $.post("/GPAtest/GPAtest/index.php/Home/Account/index", {account:account,password:password,weixin_key:weixin_key},function(data){
          ...
          if(data.status==0){
            ...
            alert('查询失败,请稍后重试');
             ...
             window.location.href="/GPAtest/GPAtest/index.php/Home/Index/index";//跳转到下一页面
